...
2. What is an event?
   Every user interaction with a site is an event: a click, moving the mouse, scrolling, pressing a key. All are events on the page and the browser can detect all of them.
